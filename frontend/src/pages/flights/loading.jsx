...
export default function Loading() {
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-4 p-4 bg-card border border-border rounded-lg shadow-lg min-h-screen max-w-6xl m-auto">
        ...
        <div className="flex-1 space-y-4">
          ...
          <Button variant="orange" className="w-full text-white" disabled>
            Quay lại trang chủ
          </Button>
        </div>
      </div>
