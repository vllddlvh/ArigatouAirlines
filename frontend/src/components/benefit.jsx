    ...
    <div>
      ...
      <section className="lg:flex">
        ...
        <div className="relative lg:w-[55%] bg-[url(/bg-map-2.png)] bg-[#313041] bg-right-bottom bg-contain flex flex-col justify-center py-16">
          <div className="absolute lg:w-3 w-0 bg-primary left-0 rounded-r-[10px] top-[120px] bottom-[120px]"></div>
          <div className="lg:w-[55%] lg:pl-24 px-6">
            <p className="text-xl text-primary" data-aos="fade-up">Danh sách lợi ích của chúng tôi</p>
            <h4 className="text-white lg:text-[50px] text-[30px] py-4" data-aos="fade-up">Tại sao chọn QAirline</h4>
            <p className="text-muted-foreground leading-8" data-aos="fade-down">
            ...
            <div className="flex lg:flex-row flex-col items-center gap-8 pt-16" data-aos="fade-up">
              <span>
                <RiFlightTakeoffFill className="text-primary text-5xl" />
              </span>
              <span>
                <h6 className="text-white text-xl">Chuyên nghiệp và được chứng nhận</h6>
                <p className="text-muted-foreground leading-8 py-4">
            ...
            <div className="flex lg:flex-row flex-col items-center gap-8 pt-6" data-aos="fade-up">
              <span>
                <GiRuleBook className="text-primary text-5xl" />
              </span>
              <span>
      ...
      <section className="lg:pt-28 pt-14 pb-14" data-aos="fade-up">
        <div className="max-w-[1200px] xl:px-0 px-6 mx-auto">
          <div className="lg:flex items-center justify-between">
            <span>
              <p className="text-xl text-primary pb-4">Từ trang tin tức</p>
              <p className="lg:text-[50px] text-3xl text-foreground font-semibold">Tin tức và Bài viết</p>
            </span>
            <Link href="/news">
      ...
      <div className="bg-[#faf5ee]" data-aos="fade-down">
        <div className="flex flex-wrap max-w-[1200px] xl:px-0 px-6 mx-auto lg:pt-28 pt-14">
          <div className="lg:w-1/2">
            <p className="text-xl text-primary pb-4">Tham gia với chúng tôi</p>
            <p className="lg:text-[50px] text-3xl text-foreground font-semibold">
            ...
            <div className="flex gap-4 pt-6">
              <Link href="/login">
                <button className="bg-primary text-white text-xs font-bold rounded flex gap-2 px-8 h-12 items-center hoverBtn hover:bg-primary hover:text-foreground">
                  <MdArrowCircleRight size={20} /> &nbsp;ĐĂNG NHẬP&nbsp;
                </button>
              </Link>
              <Link href="/signup">
                <button className="bg-white text-foreground text-xs font-bold rounded flex gap-2 px-8 h-12 items-center hoverBtn hover:bg-primary">
